...
*
* From Book AngularJS Services
* Validating complex data with a rules engine at page 120
*
* */

(function () {
    'use strict';
    angular.module('core.services').factory('RulesEngineFactory', ['$timeout','$parse','MessagingFactory','MESSAGES',


        function($timeout, $parse, MessagingFactory, MESSAGES){
